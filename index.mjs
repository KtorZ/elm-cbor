...
export function fromWordsUnsafe(words) {
...
function example(str) {
    const { words } = bech32.decode(str, 999);
    console.log(str);
    console.log(`, testEncodeWordsOk\n    [${words}]\n    [${fromWords(words)}]`);
}

example("pool10tqeu6d03p6rnalqlvdshmpsljxaq2c0ww6draq6xm8lgyl2a3p");
